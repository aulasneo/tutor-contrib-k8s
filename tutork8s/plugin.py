...
hooks.Filters.CONFIG_DEFAULTS.add_items(
    [
        ...
        # KEDA settings. KEDA is an external cluster prerequisite and these
        # settings are deliberately opt-in so the plugin remains usable on
        # clusters that only provide the Kubernetes resource metrics API.
        ("K8S_KEDA_POLLING_INTERVAL_SECONDS", 15),
        ("K8S_KEDA_FALLBACK_FAILURE_THRESHOLD", 3),
        ("K8S_KEDA_FALLBACK_REPLICAS", 1),
        ("K8S_KEDA_REDIS_PRIORITY_STEPS", [0, 3, 6, 9]),
        ("K8S_KEDA_REDIS_TLS_ENABLE", False),
        ("K8S_KEDA_REDIS_UNSAFE_SSL", False),
        ("K8S_CADDY_METRICS_PORT", 9180),
        ...
        (
            "K8S_LMS_WORKER_KEDA_QUEUE_NAMES",
            [
        ...
        (
            "K8S_CMS_WORKER_KEDA_QUEUE_NAMES",
            [
        ...
        ("K8S_LMS_WORKER_HPA_SCALE_DOWN_STABILIZATION_WINDOW_SECONDS", 600),
        ...
        ("K8S_CMS_WORKER_HPA_SCALE_DOWN_STABILIZATION_WINDOW_SECONDS", 600),
